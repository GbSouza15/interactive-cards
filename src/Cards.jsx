    ...
    return (
        <>
            <div className='card-back'>
                <img className="min-[1024px]:absolute min-[1024px]:top-[22rem] min-[1024px]:left-[12rem] min-[1024px]:w-[20rem] absolute top-[2rem] w-[17rem] right-5 min-[668px]:right-[7rem]" src="../images/bg-card-back.png"/>
                <div>
            ...
            <div className="card-front">
                <img className="min-[1024px]:absolute min-[1024px]:top-[10rem] min-[1024px]:left-[8rem] min-[1024px]:w-[20rem] absolute top-[8rem] w-[17rem] left-5 min-[668px]:left-[7rem]" src="../images/bg-card-front.png"/>
